...
# module references:
# axil_ctrl, mem_agent_maxi, mem_agent_maxi, mem_agent_maxi, mem_agent_maxi
...
proc create_root_design { parentCell } {
  ...
  set_property CONFIG.NUM_SI {1} $axi_smc1
  ...
  set_property CONFIG.NUM_SI {1} $axi_smc2
  ...
  set_property CONFIG.NUM_SI {1} $axi_smc3
  ...
  # Create instance: mem_agent_maxi_1, and set properties
  set block_name mem_agent_maxi
  set block_cell_name mem_agent_maxi_1
  if { [catch {set mem_agent_maxi_1 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mem_agent_maxi_1 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: mem_agent_maxi_2, and set properties
  set block_name mem_agent_maxi
  set block_cell_name mem_agent_maxi_2
  if { [catch {set mem_agent_maxi_2 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mem_agent_maxi_2 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  
  # Create instance: mem_agent_maxi_3, and set properties
  set block_name mem_agent_maxi
  set block_cell_name mem_agent_maxi_3
  if { [catch {set mem_agent_maxi_3 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $mem_agent_maxi_3 eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
...
\
  ...
  connect_bd_intf_net -intf_net axi_smc1_M00_AXI [get_bd_intf_pins axi_smc1/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net axi_smc2_M00_AXI [get_bd_intf_pins axi_smc2/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net axi_smc3_M00_AXI [get_bd_intf_pins axi_smc3/M00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/S_AXI_HP3_FPD]
  ...
  connect_bd_intf_net -intf_net mem_agent_maxi_0_M_AXI [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins mem_agent_maxi_0/M_AXI]
  connect_bd_intf_net -intf_net mem_agent_maxi_1_M_AXI [get_bd_intf_pins axi_smc1/S00_AXI] [get_bd_intf_pins mem_agent_maxi_1/M_AXI]
  connect_bd_intf_net -intf_net mem_agent_maxi_2_M_AXI [get_bd_intf_pins axi_smc2/S00_AXI] [get_bd_intf_pins mem_agent_maxi_2/M_AXI]
  connect_bd_intf_net -intf_net mem_agent_maxi_3_M_AXI [get_bd_intf_pins axi_smc3/S00_AXI] [get_bd_intf_pins mem_agent_maxi_3/M_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins axil_ctrl_0/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net axil_ctrl_0_wr_start_out [get_bd_pins axil_ctrl_0/wr_start0_out] [get_bd_pins mem_agent_maxi_0/w_start_in]
  connect_bd_net -net mem_agent_maxi_0_b_bit_out [get_bd_pins axil_ctrl_0/clinet1_in] [get_bd_pins mem_agent_maxi_0/b_bit_out]
  connect_bd_net -net mem_agent_maxi_0_rd_bit_out [get_bd_pins axil_ctrl_0/clinet0_in] [get_bd_pins mem_agent_maxi_0/rd_bit_out]
  ...
  connect_bd_net -net mem_agent_maxi_0_rd_req_cnt_out [get_bd_pins axil_ctrl_0/rd_req_cnt_in] [get_bd_pins mem_agent_maxi_0/rd_req_cnt_out]
  ...
  connect_bd_net -net mem_agent_maxi_1_b_bit_out [get_bd_pins axil_ctrl_0/clinet3_in] [get_bd_pins mem_agent_maxi_1/b_bit_out]
  connect_bd_net -net mem_agent_maxi_1_rd_bit_out [get_bd_pins axil_ctrl_0/clinet2_in] [get_bd_pins mem_agent_maxi_1/rd_bit_out]
  connect_bd_net -net mem_agent_maxi_2_b_bit_out [get_bd_pins axil_ctrl_0/clinet7_in] [get_bd_pins mem_agent_maxi_2/b_bit_out]
  connect_bd_net -net mem_agent_maxi_2_rd_bit_out [get_bd_pins axil_ctrl_0/clinet6_in] [get_bd_pins mem_agent_maxi_2/rd_bit_out]
  connect_bd_net -net mem_agent_maxi_3_b_bit_out [get_bd_pins axil_ctrl_0/clinet5_in] [get_bd_pins mem_agent_maxi_3/b_bit_out]
  connect_bd_net -net mem_agent_maxi_3_rd_bit_out [get_bd_pins axil_ctrl_0/clinet4_in] [get_bd_pins mem_agent_maxi_3/rd_bit_out]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc1/aresetn] [get_bd_pins axi_smc2/aresetn] [get_bd_pins axi_smc3/aresetn] [get_bd_pins axil_ctrl_0/S_AXI_ARESETN] [get_bd_pins mem_agent_maxi_0/ARESETN] [get_bd_pins mem_agent_maxi_1/ARESETN] [get_bd_pins mem_agent_maxi_2/ARESETN] [get_bd_pins mem_agent_maxi_3/ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S01_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axil_ctrl_0/clinet10_in] [get_bd_pins axil_ctrl_0/clinet11_in] [get_bd_pins axil_ctrl_0/clinet12_in] [get_bd_pins axil_ctrl_0/clinet13_in] [get_bd_pins axil_ctrl_0/clinet14_in] [get_bd_pins axil_ctrl_0/clinet15_in] [get_bd_pins axil_ctrl_0/clinet16_in] [get_bd_pins axil_ctrl_0/clinet17_in] [get_bd_pins axil_ctrl_0/clinet18_in] [get_bd_pins axil_ctrl_0/clinet19_in] [get_bd_pins axil_ctrl_0/clinet20_in] [get_bd_pins axil_ctrl_0/clinet21_in] [get_bd_pins axil_ctrl_0/clinet22_in] [get_bd_pins axil_ctrl_0/clinet23_in] [get_bd_pins axil_ctrl_0/clinet24_in] [get_bd_pins axil_ctrl_0/clinet25_in] [get_bd_pins axil_ctrl_0/clinet26_in] [get_bd_pins axil_ctrl_0/clinet27_in] [get_bd_pins axil_ctrl_0/clinet28_in] [get_bd_pins axil_ctrl_0/clinet29_in] [get_bd_pins axil_ctrl_0/clinet30_in] [get_bd_pins axil_ctrl_0/clinet31_in] [get_bd_pins axil_ctrl_0/clinet8_in] [get_bd_pins axil_ctrl_0/clinet9_in] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc1/aclk] [get_bd_pins axi_smc2/aclk] [get_bd_pins axi_smc3/aclk] [get_bd_pins axil_ctrl_0/S_AXI_ACLK] [get_bd_pins mem_agent_maxi_0/ACLK] [get_bd_pins mem_agent_maxi_1/ACLK] [get_bd_pins mem_agent_maxi_2/ACLK] [get_bd_pins mem_agent_maxi_3/ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/S01_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp3_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mem_agent_maxi_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces mem_agent_maxi_0/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mem_agent_maxi_1/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces mem_agent_maxi_1/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP3/HP1_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mem_agent_maxi_2/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces mem_agent_maxi_2/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mem_agent_maxi_3/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces mem_agent_maxi_3/M_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP5/HP3_LPS_OCM] -force
  assign_bd_address -offset 0xA0000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axil_ctrl_0/S_AXI/reg0] -force
