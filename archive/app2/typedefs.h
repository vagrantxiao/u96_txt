...
#define MAX_PKT_LEN_TX			0x1000
#define NUMBER_OF_PACKETS_TX	0x10
#define MAX_PKT_LEN_RX			0x1000
#define NUMBER_OF_PACKETS_RX	0x10


#define IP_BASE XPAR_AXIL_CTRL_0_BASEADDR
#define IP_REG0 (IP_BASE+0)
#define IP_REG1 (IP_BASE+4)
#define IP_REG2 (IP_BASE+8)
#define IP_REG3 (IP_BASE+12)
