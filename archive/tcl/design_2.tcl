...
proc create_root_design { parentCell } {
  ...
  # Create instance: util_ff_1, and set properties
  set util_ff_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ff:1.0 util_ff_1 ]
  set_property CONFIG.C_WIDTH {32} $util_ff_1


  # Create instance: util_ff_2, and set properties
  set util_ff_2 [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_ff:1.0 util_ff_2 ]
  set_property CONFIG.C_WIDTH {32} $util_ff_2
...
\
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins axil_ctrl_0/S_AXI] [get_bd_intf_pins ps8_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_0_M_AXI_HPM0_FPD [get_bd_intf_pins ps8_0_axi_periph/S00_AXI] [get_bd_intf_pins zynq_ultra_ps_e_0/M_AXI_HPM0_FPD]

  # Create port connections
  connect_bd_net -net axil_ctrl_0_dout1 [get_bd_pins axil_ctrl_0/dout1] [get_bd_pins util_ff_1/D]
  connect_bd_net -net axil_ctrl_0_dout2 [get_bd_pins axil_ctrl_0/dout2] [get_bd_pins util_ff_2/D]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axil_ctrl_0/S_AXI_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins util_ff_1/clk_enable] [get_bd_pins util_ff_2/clk_enable]
  connect_bd_net -net rst_ps8_0_100M_peripheral_reset [get_bd_pins rst_ps8_0_100M/peripheral_reset] [get_bd_pins util_ff_1/reset] [get_bd_pins util_ff_2/reset]
  connect_bd_net -net util_ff_1_Q [get_bd_pins axil_ctrl_0/din1] [get_bd_pins util_ff_1/Q]
  connect_bd_net -net util_ff_2_Q [get_bd_pins axil_ctrl_0/din2] [get_bd_pins util_ff_2/Q]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/m_axi_sg_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axil_ctrl_0/S_AXI_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins util_ff_1/clk] [get_bd_pins util_ff_2/clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axil_ctrl_0/S_AXI/reg0] -force
